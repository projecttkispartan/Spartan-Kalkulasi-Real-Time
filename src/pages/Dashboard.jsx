  ...
  return (
    <div className="page-shell flex flex-col">
      <AppHeader>
        ...
        <button onClick={onNewProject} className="btn-primary shadow-brand-500/30">
              ...
              {mockProjects.map((p, index) => (
                <tr key={p.id} className="border-b border-slate-100 hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="py-4 px-4 border-r border-slate-100">
                    <button onClick={onNewProject} className="text-sm font-bold text-slate-800 hover:text-brand-600 hover:underline transition-colors">
                      {p.kode}
                    </button>
                  </td>
                  <td className="py-4 px-4 border-r border-slate-100">
                    <button onClick={onNewProject} className="text-sm font-bold text-brand-700 hover:text-brand-800 hover:underline transition-colors">
                      {p.nama}
                    </button>
                  </td>
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center justify-center gap-2">
                      <button onClick={onNewProject} className="p-1.5 text-brand-500 bg-brand-50 border border-brand-100 rounded-lg hover:bg-brand-100 transition-colors" title="Edit">
                        <SquarePen className="w-4 h-4" />
                      </button>
                      <button className="p-1.5 text-red-500 bg-red-50 border border-red-100 rounded-lg hover:bg-red-100 transition-colors" title="Hapus">
